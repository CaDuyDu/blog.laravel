		    	...
		    	<div class="share-post">
			    	<div class="share">
			    		...
			    		<ul class="social-network social-circle">
			    			{{-- share facebook --}}
			    			<li>
			    				<div class="fb-share-button" data-href="{{ url()->current() }}" data-layout="button_count" data-size="small" data-mobile-iframe="true">Share</div>
			    			</li>
			    			{{-- end share facebook --}}
			    		</ul>
			    	</div>
			    		...
			    		<div class="author-info">
			    			...
			    			<div class="author-description">
			    				...
			    				<div class="icon-social-follow">
									<div class="fb-follow" data-href="https://www.facebook.com/duydukma" data-layout="button_count" data-size="small" data-show-faces="true"></div>
			    				</div>
			    			</div>
			    		</div>
			    	</div>
